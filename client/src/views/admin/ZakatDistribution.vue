    ...
    <div class="filter-section mb-6 p-4 bg-gray-50 rounded-lg">
      ...
      <div class="flex flex-wrap gap-4">
        <div class="date-range flex items-center gap-2">
          <label>From:</label>
          <input type="date" v-model="dateRange.from" class="border rounded p-2" />
        </div>
        <div class="date-range flex items-center gap-2">
          <label>To:</label>
          <input type="date" v-model="dateRange.to" class="border rounded p-2" />
        </div>
        <button
                  ...
                  <span
                    :class="{
                      'bg-green-100 text-green-800':
                        recipient.amountReceived >= recipient.amountNeeded,
      ...
      <div v-if="distributionComplete" class="distribution-results mt-4">
        ...
        >
          <h4 class="font-medium">
            {{ recipient.name }} - RM {{ formatNumber(recipient.amountReceived) }}
          </h4>
